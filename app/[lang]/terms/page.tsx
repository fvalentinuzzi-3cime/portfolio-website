  ...
  return (
    <div className={`min-h-screen bg-[#E9E8E6] text-stone-800 ${inter.className}`}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-24">
        <h1 className="text-4xl font-light mb-12">{dict.termsPage.title}</h1>
        <div className="space-y-8 text-sm font-light text-stone-600 leading-relaxed">
          <p>{dict.termsPage.updated}</p>
          <section>
            <h2 className="text-lg text-stone-800 mb-3 font-normal">{dict.termsPage.sec1Title}</h2>
            <p>{dict.termsPage.sec1Desc}</p>
          </section>
          <section>
            <h2 className="text-lg text-stone-800 mb-3 font-normal">{dict.termsPage.sec2Title}</h2>
            <p>{dict.termsPage.sec2Desc}</p>
          </section>
          <section>
            <h2 className="text-lg text-stone-800 mb-3 font-normal">{dict.termsPage.sec3Title}</h2>
            <p>{dict.termsPage.sec3Desc}</p>
          </section>
        </div>
      </main>
    </div>
